...
export function ShortcutsDialog({ show, onClose }) {
  return (
    <dialog class={`modal ${show ? 'modal-open' : ''}`}>
      <div class="modal-box max-w-lg">
        <div class="flex items-center justify-between mb-4">
          <h3 class="font-bold text-lg">{t('help.title')}</h3>
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <div class="grid grid-cols-2 gap-2 text-sm">
              ...
              <div>{t('help.toggleShortcuts')}</div>
              <div><kbd class="kbd kbd-sm">H</kbd></div>
